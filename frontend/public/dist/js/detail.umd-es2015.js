...
var DetailView = (function (SiftView) {
  ...
  DetailView.prototype.presentView = function presentView (value) {
  ...
  DetailView.prototype._updateView = function _updateView () {
    var this$1 = this;

    if(this._trackers) {
      var ul = document.querySelector('.trackerlist');
      while(ul.firstChild) {
  ...
  DetailView.prototype.willPresentView = function willPresentView (value) {};
