    ...
    */
    ...
    var SummaryView = (function (SiftView) {
      ...
      SummaryView.prototype._updateGraph = function _updateGraph (data){
        ...
        var scale = ordinal(presentation10.lighter);
        ...
        this._div
          ...
          .enter().append('div')
            ...
            .style('font-size', function (d) { return (d.x1 < 10 ? '10' : d.x1 < 20 ? '15' : '20' ) + 'px'; })
            .style('background', function (d) { return d.name === 'no-trackers-found' || d.children ? 'white' : scale(getLabel(d)); })
          .append('div')
            ...
            .style('background-size', function (d) { return d.data.id ? 'contain' : 'initial'; })
      };
