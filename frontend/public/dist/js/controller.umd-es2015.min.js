...
var PixelTrackerController = (function (SiftController) {
  ...
  PixelTrackerController.prototype.onStorageUpdate = function onStorageUpdate (updated) {
    var this$1 = this;

    this._getData().then(function (data) {
      this$1.publish('storageupdated', data);
    });
  };

  PixelTrackerController.prototype._getData = function _getData () {
    var ps = [];
    return this.storage.get({
      bucket: 'senderdomains',
      keys: [
        moment$1().format('YYYYMM'),
        moment$1().subtract(1, 'month').format('YYYYMM'),
        moment$1().subtract(2, 'months').format('YYYYMM'),
        moment$1().subtract(3, 'months').format('YYYYMM'),
        moment$1().subtract(4, 'months').format('YYYYMM'),
        moment$1().subtract(5, 'months').format('YYYYMM')
      ]
